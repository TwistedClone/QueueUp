...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference("Friend.count") do
      post friends_url, params: { friend: { friend: @friend.friend, friend_score: @friend.friend_score } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { friend: @friend.friend, friend_score: @friend.friend_score } }
